...
```{r, results='asis'}
intro_text <- glue("PhD of Crop genetics and breeding at [China Agricultural University](http://www.cau.edu.cn/).")
...
I am broadly interested in comparative genomics, molecular evolution, epigenomics, 3D genomics, bioinformatics, data integration and visualization.

本人对比较基因组学，分子进化，表观遗传学，三维基因组学，生物信息学，数据处理及可视化等方面有着广泛兴趣。
...
Conference attendance 学术活动 {data-icon=group}
--------------------------------------------------------------------------------
