...
- <i class="fa fa-envelope"></i> ymhuang@cau.edu.cn
- <i class="fa fa-github"></i> github.com/sdws1983
...
```{r, results='asis'}
intro_text <- glue("PhD candidate of Crop genetics and breeding at [China Agricultural University](http://www.cau.edu.cn/).")
...
I am broadly interested in plant genomics, comparative genomics, molecular evolution, epigenomics, 3D genomics, bioinformatics, data integration and visualization.
...
::: aside
![](figures/guojiang.jpeg){width=100%}
:::
